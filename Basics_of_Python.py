...
@author: syedheena
"""
# Note: Input values have already been provided in the following programs. You can change the values of the inputs if required.
# Problem statement 1
"""
You are given a value in Fahrenheit. Convert this value into Celsius. Also, print the following for the converted value:
    1.If the temperature is more than 0 degrees, print Above freezing point.
    2. If the temperature is between 0 to 17, print Cold.
    3. If the temperature is between 18 to 35, print Normal.
    4. If the temperature is between 36 to 45, print Warm.
    5. If the temperature is more than 45, print Extreme heat.
    6. If the temperature is less than 0, print Below freezing point.
    7. If the temperature is equal to 0, print Temperature equal to freezing point.  
"""
# Solution 1
class conv_temp:   # Creating a class 
    
    def Fah_to_Cel(self, F):    # This function takes the value F = 88 
        C = (F - 32)*5/9         
        return C                
...
con_F_to_C_value = obj1.Fah_to_Cel(77)   # Storing the returned value 
print("The converted value is {} C".format(con_F_to_C_value))   # Printing the result
res = obj1.temp_determine(con_F_to_C_value)  # Storing the returned value 
...
class GCD:      # Creating a class
    ...
    def __init__(self, a=0, b=0):       # Initializing the constructor, it is called when ever an object of the class is constructed.
        self.a = a
        self.b = b
...
GCD_res = obj2.ComputeGCD(num1, num2)   # Storing the returned value
...
You are given a list of numbers. You are required to perform the following tasks on this list:
    ...
    2. Remove any element that is less than 0 from the list and print the new list.
    3. Determine the index of elements that are divisible by 5 from the list.
    4. Check whether there are any elements in the list that are equal to 10. If yes, return the total count.
    5. Determine the index of the first element that is divisible by 3 in the list and insert 100 next to it.
...
# Problem statement 4
"""
Consider the same list mentioned in problem statement 3. Determine the following:
    1. Average of all the numbers in the list.
    2. If any value is present more than once, remove the element and print a new list.
    3. Print the maximum and minimum value of the new list.
"""
# Solution 4
...
You are given a tuple. Perform the following operations on it:
    ...
    2. Convert the tuple into a dictionary.
...
class Tuple_operation:      # Creating the class
    ...
    def sorting(self, tuple_to_list):   # # Function that sorts the packed list based on the condition provided in the problem statement
...
# Problem statement 6
"""
You are given information about some items in a store and their prices in the form of a dictionary. Perform the following operations on this dictionary:
    1. Print the items that have prices greater than the average of all the prices of the items.
    2. Add a new item "Pineapple" with a price of Rs. 100.
    3. Group items that have the same price.
    4. Print the item that has a price of less than Rs. 5.
"""
# Solution 6
class item_price:       # Creating the class
    ...
    def less_than_5(self):      # # Function that returns the item that has a price that is less than 5
